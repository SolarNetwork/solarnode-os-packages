# SolarNode Platform - Spring Security change log
...
| Name                                                      | ID                                                        | Vers  |
|:----------------------------------------------------------|:----------------------------------------------------------|:------|
| Apache ServiceMix :: Bundles :: spring-security-acl       | `org.apache.servicemix.bundles.spring-security-acl`       | 6.4.6 |
| Apache ServiceMix :: Bundles :: spring-security-config    | `org.apache.servicemix.bundles.spring-security-config`    | 6.4.6 |
| Apache ServiceMix :: Bundles :: spring-security-core      | `org.apache.servicemix.bundles.spring-security-core`      | 6.4.6 |
| Apache ServiceMix :: Bundles :: spring-security-crypto    | `org.apache.servicemix.bundles.spring-security-crypto`    | 6.4.6 |
| Apache ServiceMix :: Bundles :: spring-security-data      | `org.apache.servicemix.bundles.spring-security-data`      | 6.4.6 |
| Apache ServiceMix :: Bundles :: spring-security-messaging | `org.apache.servicemix.bundles.spring-security-messaging` | 6.4.6 |
| Apache ServiceMix :: Bundles :: spring-security-web       | `org.apache.servicemix.bundles.spring-security-web`       | 6.4.6 |
