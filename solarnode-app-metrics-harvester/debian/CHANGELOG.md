# SolarNode Application - Metrics Harvester - change log
...
This release requires [`solarnode-app-core` 4.10][app-core-log] or newer.

The complete list of plugins included is:

| Name              | ID                        | Vers  |
|:------------------|:--------------------------|:------|
| Metrics Harvester | `n.s.n.metrics.harvester` | 2.1.0 |
