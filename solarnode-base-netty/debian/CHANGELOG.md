...
| Name                               | ID                                      | Vers   |
|:-----------------------------------|:----------------------------------------|:-------|
| Netty/Buffer                       | `io.netty.buffer`                       | 4.2.17 |
| Netty/Codec                        | `io.netty.codec`                        | 4.2.17 |
| Netty/Codec/Base                   | `io.netty.codec-base`                   | 4.2.17 |
| Netty/Codec/Compression            | `io.netty.codec-compression`            | 4.2.17 |
| Netty/Codec/HTTP                   | `io.netty.codec-http`                   | 4.2.17 |
| Netty/Codec/HTTP2                  | `io.netty.codec-http2`                  | 4.2.17 |
| Netty/Codec/MQTT                   | `io.netty.codec-mqtt`                   | 4.2.17 |
| Netty/Codec/Stomp                  | `io.netty.codec-stomp`                  | 4.2.17 |
| Netty/Common                       | `io.netty.common`                       | 4.2.17 |
| Netty/Handler                      | `io.netty.handler`                      | 4.2.17 |
| Netty/Resolver                     | `io.netty.resolver`                     | 4.2.17 |
| Netty/Transport                    | `io.netty.transport`                    | 4.2.17 |
| Netty/Transport/Native/Unix/Common | `io.netty.transport-native-unix-common` | 4.2.17 |
...
| Name                               | ID                                      | Vers   |
|:-----------------------------------|:----------------------------------------|:-------|
| Netty/Buffer                       | `io.netty.buffer`                       | 4.2.15 |
| Netty/Codec                        | `io.netty.codec`                        | 4.2.15 |
| Netty/Codec/Base                   | `io.netty.codec-base`                   | 4.2.15 |
| Netty/Codec/Compression            | `io.netty.codec-compression`            | 4.2.15 |
| Netty/Codec/HTTP                   | `io.netty.codec-http`                   | 4.2.15 |
| Netty/Codec/HTTP2                  | `io.netty.codec-http2`                  | 4.2.15 |
| Netty/Codec/MQTT                   | `io.netty.codec-mqtt`                   | 4.2.15 |
| Netty/Codec/Stomp                  | `io.netty.codec-stomp`                  | 4.2.15 |
| Netty/Common                       | `io.netty.common`                       | 4.2.15 |
| Netty/Handler                      | `io.netty.handler`                      | 4.2.15 |
| Netty/Resolver                     | `io.netty.resolver`                     | 4.2.15 |
| Netty/Transport                    | `io.netty.transport`                    | 4.2.15 |
| Netty/Transport/Native/Unix/Common | `io.netty.transport-native-unix-common` | 4.2.15 |
...
| Name                               | ID                                      | Vers  |
|:-----------------------------------|:----------------------------------------|:------|
| Netty/Buffer                       | `io.netty.buffer`                       | 4.2.9 |
| Netty/Codec                        | `io.netty.codec`                        | 4.2.9 |
| Netty/Codec/Base                   | `io.netty.codec-base`                   | 4.2.9 |
| Netty/Codec/Compression            | `io.netty.codec-compression`            | 4.2.9 |
| Netty/Codec/HTTP                   | `io.netty.codec-http`                   | 4.2.9 |
| Netty/Codec/HTTP2                  | `io.netty.codec-http2`                  | 4.2.9 |
| Netty/Codec/MQTT                   | `io.netty.codec-mqtt`                   | 4.2.9 |
| Netty/Codec/Stomp                  | `io.netty.codec-stomp`                  | 4.2.9 |
| Netty/Common                       | `io.netty.common`                       | 4.2.9 |
| Netty/Handler                      | `io.netty.handler`                      | 4.2.9 |
| Netty/Resolver                     | `io.netty.resolver`                     | 4.2.9 |
| Netty/Transport                    | `io.netty.transport`                    | 4.2.9 |
| Netty/Transport/Native/Unix/Common | `io.netty.transport-native-unix-common` | 4.2.9 |
