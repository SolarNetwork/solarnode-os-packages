...
| Name          | ID                       | Vers  |
|:--------------|:-------------------------|:------|
| Modbus Server | `n.s.n.io.modbus.server` | 5.6.1 |
...
| Name          | ID                       | Vers  |
|:--------------|:-------------------------|:------|
| Modbus Server | `n.s.n.io.modbus.server` | 5.6.0 |
...
| Name          | ID                       | Vers  |
|:--------------|:-------------------------|:------|
| Modbus Server | `n.s.n.io.modbus.server` | 5.5.1 |
...
| Name          | ID                       | Vers  |
|:--------------|:-------------------------|:------|
| Modbus Server | `n.s.n.io.modbus.server` | 5.5.0 |
...
| Name          | ID                       | Vers  |
|:--------------|:-------------------------|:------|
| Modbus Server | `n.s.n.io.modbus.server` | 5.4.0 |
...
| Name                | ID                       | Vers  |
|:--------------------|:-------------------------|:------|
| Modbus Server (TCP) | `n.s.n.io.modbus.server` | 5.3.0 |
...
| Name                | ID                       | Vers  |
|:--------------------|:-------------------------|:------|
| Modbus Server (TCP) | `n.s.n.io.modbus.server` | 5.2.0 |
...
| Name                | ID                       | Vers  |
|:--------------------|:-------------------------|:------|
| Modbus Server (TCP) | `n.s.n.io.modbus.server` | 5.1.1 |
...
| Name                | ID                       | Vers  |
|:--------------------|:-------------------------|:------|
| Modbus Server (TCP) | `n.s.n.io.modbus.server` | 5.1.0 |
