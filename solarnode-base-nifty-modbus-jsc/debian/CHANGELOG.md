...
| Name                                  | ID                             | Vers  |
|:--------------------------------------|:-------------------------------|:------|
| SolarNetwork Modbus API               | `n.s.common.io.modbus.api`     | 1.5.0 |
| SolarNetwork Modbus Core              | `n.s.common.io.modbus.core`    | 1.5.0 |
| SolarNetwork Modbus RTU (Core)        | `n.s.common.io.modbus.rtu`     | 1.5.0 |
| SolarNetwork Modbus RTU (jSerialComm) | `n.s.common.io.modbus.rtu.jsc` | 1.5.0 |
| SolarNetwork Modbus TCP               | `n.s.common.io.modbus.tcp`     | 1.5.0 |
...
| Name                                  | ID                             | Vers  |
|:--------------------------------------|:-------------------------------|:------|
| SolarNetwork Modbus API               | `n.s.common.io.modbus.api`     | 1.4.0 |
| SolarNetwork Modbus Core              | `n.s.common.io.modbus.core`    | 1.4.0 |
| SolarNetwork Modbus RTU (Core)        | `n.s.common.io.modbus.rtu`     | 1.4.0 |
| SolarNetwork Modbus RTU (jSerialComm) | `n.s.common.io.modbus.rtu.jsc` | 1.4.0 |
| SolarNetwork Modbus TCP               | `n.s.common.io.modbus.tcp`     | 1.4.0 |
...
| Name                                  | ID                             | Vers  |
|:--------------------------------------|:-------------------------------|:------|
| SolarNetwork Modbus API               | `n.s.common.io.modbus.api`     | 1.3.0 |
| SolarNetwork Modbus Core              | `n.s.common.io.modbus.core`    | 1.3.0 |
| SolarNetwork Modbus RTU (Core)        | `n.s.common.io.modbus.rtu`     | 1.3.0 |
| SolarNetwork Modbus RTU (jSerialComm) | `n.s.common.io.modbus.rtu.jsc` | 1.3.0 |
| SolarNetwork Modbus TCP               | `n.s.common.io.modbus.tcp`     | 1.3.0 |
...
| SolarNetwork Modbus RTU (jSerialComm) | `n.s.common.io.modbus.rtu.jsc` | 0.18.0 |
...
| SolarNetwork Modbus RTU (jSerialComm) | `n.s.common.io.modbus.rtu.jsc` | 0.17.0 |
